...
public class ProfileMatrix {
    ...
    //LU-разложение матрицы, матрица L без диагонали хранится на местк al, диагональ L на месте d, матрица U без диагонали хранится на местк au, диагональ U - сосотит из всех 1
