...
import static methods.LUMethod.readLU;
...
public class Test2 {
    public static void main(String[] args) {
        ...
        for (int n = 10; n <= 1000; n += 100) {
            ...
            generator.generatePMandWrite(n, filename);
    ...
    private static final String dirName = "test2";

    private static String getFileName(int k) {
        return dirName + File.separatorChar + "t" + k;
    }
